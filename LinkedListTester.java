//Shankar Choudhury, Connor Fant, Tanisha Nagori
import org.junit.*;
...
public class LinkedListTester {
  ...
  public void testContains() {
    ...
    oneList.addToFront(1);
    list.addToFront(3);
    list.addToFront(2);
    list.addToFront(1);
    assertEquals("Failed at start", true, list.contains(1));
    assertEquals("Failed at middle", true, list.contains(2));
    assertEquals("Failed at end", true, list.contains(3));
    assertEquals("False positive", false, list.contains(0));
    assertEquals("Failed with empty list", false, emptyList.contains(3));
    assertEquals("Failed with one node", true, list.contains(1));
  }
