...
public class DoubleLinkedList<T> implements Iterable<T> {
  ...
  public void addToFront(T element) {
    ...
    if (this.getFront() == null) {
      DLNode<T> frontNode = new DLNode<T> (element, null, null);
      this.setFront(frontNode);
      this.setBack(frontNode);
    }
    else {
      DLNode<T> frontNode = new DLNode<T>(element, null, this.getFront());
      this.getFront().setPrevious(frontNode);
      this.setFront(frontNode);
    }
  }
  ...
  public void addToBack(T element) {
    if (this.getFront() == null) {
      DLNode<T> backNode = new DLNode<T> (element, null, null);
      this.setFront(backNode);
      this.setBack(backNode);
    }
    else {
      DLNode<T> backNode = new DLNode<T>(element, this.getBack(), null);
      this.getBack().setNext(backNode);
      this.setBack(backNode);
    }
